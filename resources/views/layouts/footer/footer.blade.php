...
<script type="text/javascript" src="{{asset('1.x-1.1.15/markitup/jquery.markitup.js')}}"></script>
  <script type="text/javascript" src="{{asset('1.x-1.1.15/markitup/sets/default/set.js')}}"></script>
